...
public class Pageclass {
    ...
    public void AddressInfo() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(firstName)).sendKeys("Rohith");
        wait.until(ExpectedConditions.visibilityOfElementLocated(lastName)).sendKeys("chekurthi");
        wait.until(ExpectedConditions.visibilityOfElementLocated(address)).sendKeys("PG, Ayyappa society, Madhapur, Hyderabad");
        wait.until(ExpectedConditions.visibilityOfElementLocated(province)).sendKeys("Telangana");
        wait.until(ExpectedConditions.visibilityOfElementLocated(postCode)).sendKeys("500018");
    }
